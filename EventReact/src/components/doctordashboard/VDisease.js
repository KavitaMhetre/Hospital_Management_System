...
const Vdiseases = () => {
    ...
    function fetchVendors(tokens) {
        axios.get("http://localhost:3000/api/vendor-all-diseases", { headers: { "Authorization": `Bearer ${tokens}` } })
            .then((res) => {
    ...
    function handleAccept(eid){
        ...
        axios.post("http://localhost:3000/api/accept-disease", edata,{ headers: { "Authorization": `Bearer ${token}` } })
            .then((res) => {
                        ...
                        <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
                            <div class="sidebar">
                                <div class="widget patient-dashboard-profile">
                                    <h2>Profile</h2>
                                    <h5 class="text-center">{patient.vname}</h5>
                                    <p>{patient.vemail}</p>
                                ...
                                <div class="widget patient-dashboard-menu">
                                    <ul>
                                        ...
                                        <li class="active"><a href="/vendor-diseases"><i class="fa fa-patient"></i> New  diseases</a></li>
                                                        ...
                                                        <div class="ad-listing-content">
                                                            ...
                                                            <ul class="list-inline mt-2 mb-3">
                                                                <li class="list-inline-item"><a href="#"> <i class="fa fa-folder-open-o"></i>
                                                                    {obj.etype}</a></li>
                                                                <li class="list-inline-item"><a href="#"> <i class="fa fa-patient"></i>
                                                                    {obj.name}</a></li>
