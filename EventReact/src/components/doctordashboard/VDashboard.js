...
const VDashboard = () => {
    ...
    function fetchdoctors(tokens) {
        axios.get("http://localhost:3000/api/doctor-get-diseases", { headers: { "Authorization": `Bearer ${tokens}` } })
            .then((res) => {
                        ...
                        <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
                            <div class="sidebar">
                                ...
                                <div class="widget patient-dashboard-menu">
                                    <ul>
                                        <li class="active"><a href="/doctor-dashboard"><i class="fa fa-bookmark-o"></i> My Works</a></li>
                                        <li><a href="/doctor-diseases"><i class="fa fa-patient"></i> New  diseases</a></li>
